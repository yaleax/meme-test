...
updatesChannel.addEventListener('message', event => {
            ...
            let a = this.document.querySelector('meta[name=theme-color]')
  ...
  this.document.body.appendChild(b),
  setTimeout(function() {
      this.document.getElementById('app-refresh').className += ' app-refresh-show'
  }, 16)
  console.log("log")
